...
for (let characters = 0; characters < starWarsCharacters.length; characters++) {
  console.log("character", starWarsCharacters[characters].name);
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "female") {
    femaleCharacter.push(starWarsCharacters[i]);
  }

  console.log("Female Charcters", femaleCharacter);
}
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  let eyeColor = starWarsCharacters[i];
  switch (starWarsCharacters[i].eye_color) {
    case "blue":
      starWarsCharacters[i].eye_color = ["blue"];
      break;
    case "yellow":
      starWarsCharacters[i].eye_color = ["yellow"];
      break;
    case "brown":
      starWarsCharacters[i].eye_color = ["brown"];
      break;
    case "red":
      starWarsCharacters[i].eye_color = ["red"];
      break;
    case "blueGray":
      starWarsCharacters[i].eye_color = ["blue-gray"];
      break;
  }
}
...
while (i < starWarsCharacters.length) {
  let masses = starWarsCharacters[i];
  totmass += parseInt(masses.mass)
  i++;
}
